...
public class RenderPlayerRenderer {
    public static Quaternionf cameraOrientation = LinearAlgebra.QUATERNION_ONE;

    // EntityRenderDispatcher#render
    public static void render(PoseStack stack, PlayerRendereType player, MultiBufferSource bufferSource, double xOffset, double yOffset, double zOffset, float rotation, float delta, int light) {
        try {
    ...
    private static Vec3 getRenderOffset(PlayerRendereType player, float delta) {
        return player.isSneaking() ? new Vec3(0.0D, -0.125D, 0.0D) : Vec3.ZERO;
    }

    // PlayerRenderer#render
    private static void drawFakePlayer(PlayerRendereType player, float rotation, float delta, PoseStack stack, MultiBufferSource bufferSource, int light) {
    ...
    private static void drawLivingEntity(PlayerRendereType player, float rotation, float delta, PoseStack stack, MultiBufferSource bufferSource, int light) {
        stack.pushPose();
    ...
    private static void setupRotations(PlayerRendereType player, PoseStack stack, float f, float g, float h) {
    ...
    private static void renderNameTag(PlayerRendereType player, PoseStack stack, MultiBufferSource bufferSource, int light) {
