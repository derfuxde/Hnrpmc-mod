...
public class Indicators {
    public static final ResourceLocation ANIMATED = ResourceLocation.tryBuild("cosmetica", "textures/gui/icon/animated.png");
    public static final ResourceLocation LOCK_TO_TORSO = ResourceLocation.tryBuild("cosmetica", "textures/gui/icon/lock_to_torso.png");
    public static final ResourceLocation MIRROR = ResourceLocation.tryBuild("cosmetica", "textures/gui/icon/mirror.png");
    public static final ResourceLocation SW_CAPE = ResourceLocation.tryBuild("cosmetica", "textures/gui/icon/show_with_cape.png");
    public static final ResourceLocation SW_CHESTPLATE = ResourceLocation.tryBuild("cosmetica", "textures/gui/icon/show_with_chestplate.png");
    public static final ResourceLocation SW_HELMET = ResourceLocation.tryBuild("cosmetica", "textures/gui/icon/show_with_helmet.png");
    public static final ResourceLocation SW_PARROT = ResourceLocation.tryBuild("cosmetica", "textures/gui/icon/show_with_parrot.png");
