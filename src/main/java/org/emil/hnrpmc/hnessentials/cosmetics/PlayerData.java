...
public class PlayerData {
    ...
    public PlayerData(ResourceLocation skin, boolean slim) {
        this(
                "",           // lore: leerer String
                false,        // upsideDown: aus
                null,         // icon: kein Icon
                false,        // online: standardmäßig offline
                "",           // prefix: leer
                "",           // suffix: leer
                new ArrayList<>(), // hats: leere Liste (verhindert NullPointerException!)
                null,         // cape: kein Cape
                null,         // leftShoulderBuddy
                null,         // rightShoulderBuddy
                null,         // backBling
                skin,         // Skin übergeben
                slim          // Slim-Status übergeben
        );
    }
    ...
    private static final Set<UUID> lookingUp = new HashSet<>();
