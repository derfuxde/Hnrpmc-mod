...
import static org.emil.hnrpmc.simpleclans.commands.contexts.Contexts.validateMinMax;
...
public class DoublePrimitiveContextResolver extends AbstractInputOnlyContextResolver<Double> {
    ...
    @Override
    public Double getContext(CommandExecutionContext context) throws InvalidCommandArgument {
