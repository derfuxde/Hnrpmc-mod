...
public final class Helper {
    ...
    public static String getColorName(String playerName) {
        List<ServerPlayer> players = ServerLifecycleHooks.getCurrentServer().getPlayerList().getPlayers()
                .stream()
                .filter(p -> p.getName().getString().toLowerCase().startsWith(playerName.toLowerCase()))
                .toList();
    ...
    @NotNull
    public static String getFormattedClanStatus(Clan clan, CommandSourceStack sender) {
