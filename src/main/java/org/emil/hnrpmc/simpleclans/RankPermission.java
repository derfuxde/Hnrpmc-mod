...
public enum RankPermission {
    ...
    RANK_CREATE("simpleclans.leader.rank.create", PermissionLevel.LEADER),
    RANK_DELETE("simpleclans.leader.rank.delete", PermissionLevel.LEADER),
    RANK_MEMBER_ADD("simpleclans.leader.rank.member.add", PermissionLevel.LEADER),
    RANK_MANAGE("simpleclans.leader.rank.manage", PermissionLevel.LEADER),
	 ...
	 */
	public String getNeoPermission() {
		return neoermission;
	}
