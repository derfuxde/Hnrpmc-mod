package org.emil.hnrpmc.simpleclans.language;
...
public class LanguageResource {
    ...
    private static void loadAvailableLocales() {
        ...
        for (Path filePath : Helper.getPathsIn(SimpleClans.getInstance().getLangDataFolder().toString(), filter)) {
    ...
    private static @NotNull Locale getLocaleByFileName(@NotNull String name) {
        Locale locale;
        if (name.equalsIgnoreCase(SimpleClans.getInstance().getLangDataFolder() + "messages.properties")) {
